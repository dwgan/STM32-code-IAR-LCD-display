        ...
        if (*String == '%')
        {
            ...
            switch(*String)
            {
                case 'd':
                {
                    for (i = 0; i < ByteLengh; i++)
                    {
                        DisplayBuff[X_Set+ByteLengh-i-1] = Num%10 + 48;
                        Num = Num/10;
                    }
                    for (i = 0; i < ByteLengh - 1; i++)
                    {
                        if (DisplayBuff[X_Set+i] == 48)
                            DisplayBuff[X_Set+i] = 32;
                        else
                            break;
                    }
                    X_Set += ByteLengh;
